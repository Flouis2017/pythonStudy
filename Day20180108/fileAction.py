...
# 重命名处理：os.rename(old,new)
# 产生异常的可能原因:(1)oldfilename旧文件名不存在（文件须带扩展名）   
# (2)newFilename新文件已经存在
#old_file_path = 'C:/Users/Administrator/Desktop/Pactera/Flouis/新建文件夹'
#new_file_path = 'C:/Users/Administrator/Desktop/Pactera/Flouis/xinjian'
#os.rename(old_file_path,new_file_path)

# 文件删除：os.remove(file_path)或者shutil.rmtree(dir_path)
#【说明】：os.remove(...)用于删除单一文件；shutil.rmtree(...)用于删除整个文件目录
#产生异常的可能原因:(1)路径不存在 (3)没有操作权限或只读
#file_path = 'C:/Users/Administrator/Desktop/Pactera/Flouis/mytest.txt'
#os.remove(file_path)
#dir_path = 'C:/Users/Administrator/Desktop/Pactera/Flouis/xinjian'
